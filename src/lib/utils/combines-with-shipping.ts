import { shopifyAuthenticatedFetch } from '../utils/index.js';
import {
...
export async function updateAutomaticAppDiscount(id: string) {
  const updatedDiscount =
    await shopifyAuthenticatedFetch<DiscountAutomaticAppUpdateMutation>(
      discountAutomaticAppUpdate,
      {
        id,
...
export async function updateAutomaticBasicDiscount(id: string) {
  const updatedDiscount =
    await shopifyAuthenticatedFetch<DiscountAutomaticBasicUpdateMutation>(
      discountAutomaticBasicUpdate,
      {
        id,
...
export async function updateAutomaticBxgyDiscount(id: string) {
  const updatedDiscount =
    await shopifyAuthenticatedFetch<DiscountAutomaticBxgyUpdateMutation>(
      discountAutomaticBxgyUpdate,
      {
        id,
...
export async function updateAutomaticFreeShippingDiscount(id: string) {
  const updatedDiscount =
    await shopifyAuthenticatedFetch<DiscountAutomaticFreeShippingUpdateMutation>(
      discountAutomaticFreeShippingUpdate,
      {
        id,
...
export async function updateDiscountCodeBasic(id: string) {
  const updatedDiscount =
    await shopifyAuthenticatedFetch<DiscountCodeBasicUpdateMutation>(
      discountCodeBasicUpdate,
      {
        id,
        basicCodeDiscount: {
...
export async function updateDiscountCodeBxgy(id: string) {
  const updatedDiscount =
    await shopifyAuthenticatedFetch<DiscountCodeBxgyUpdateMutation>(
      discountCodeBxgyUpdate,
      {
        id,
        bxgyCodeDiscount: {
...
export async function updateDiscountCodeFreeShipping(id: string) {
  const updatedDiscount =
    await shopifyAuthenticatedFetch<DiscountCodeFreeShippingUpdateMutation>(
      discountCodeFreeShippingUpdate,
      {
        id,
